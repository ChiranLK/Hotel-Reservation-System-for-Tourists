        ...
        <section>
            <div class="addHotel">
                <form action="" class="input-form" method="post">
                    ...
                    <div class="form-div2">
                        <label for="HO_ID">Hotel Owner :</label>
                ...
                <?php
                    if (isset($_POST['add'])) {
                        ...
                        $sql = "INSERT INTO Hotel(RegNo,HO_ID,Name,H_type,Location,Avl_Rooms,Email) VALUES ('$RegNo', '$HO_ID', '$name', '$h_type', '$location', '$rooms', '$email')";
